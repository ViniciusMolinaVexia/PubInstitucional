...
const ResidenciaAgradecimento = ({ homeContent , location , displayColor  })=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_share_layouts_layout_main__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
        ...
        children: [
            !isMobile && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_share_components_backButton__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
                link: `residencia/${homeContent.slug}`,
                colors: homeContent.displayColors
            }),
...
ResidenciaAgradecimento.getInitialProps = async ({ req , query  })=>{
    const enterpriseService = new _share_service_enterprises__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z();
    const empreendimento = await enterpriseService.getEnterpriseBySlugTitle(_Envirioment_Envirioment__WEBPACK_IMPORTED_MODULE_9__/* .SLUG_DOM_PEDRO */ .Nj, true);
    return {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ResidenciaAgradecimento);
...
var __webpack_exports__ = __webpack_require__.X(0, [2952,1270,1664,1890,1790,5176,1659,4756,5129,2750,3817], () => (__webpack_exec__(4772)));
